...
for metadata in metas:
    # Define folders for BiomedCLIP
    root_dir = os.path.dirname(os.path.dirname('__file__'))
    data_folder = os.path.join(root_dir, "data", "chexpert", "biomedclip", metadata)
    figures_folder = os.path.join(root_dir, "fig", "chexpert", "biomedclip", f"predict-{metadata}")
    models_folder = os.path.join(root_dir, "models", "chexpert", "biomedclip", metadata)
    ...
    # Load models (trained on BiomedCLIP embeddings), for each fold
