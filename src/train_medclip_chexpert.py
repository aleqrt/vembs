...
embedding_folder = os.path.join(chexpert_data_folder, "medclip")
extracted_embedding_folder = os.path.join(chexpert_data_folder, "medclip")
...
embed_pkl = os.path.join(embedding_folder, "embedding_from_medclip.pkl")
...
print("Loading CheXpert embeddings from MedCLIP...")
...
# ----------------------------------------------------------------
id_split_path = os.path.join(extracted_embedding_folder, "train_test_ids.pkl")
...
for meta in metas:
    ...
    models_folder = os.path.join(root_dir, "models", "chexpert", "medclip", meta)
    figures_folder = os.path.join(root_dir, "fig", "chexpert", "medclip", f"predict-{meta}")
