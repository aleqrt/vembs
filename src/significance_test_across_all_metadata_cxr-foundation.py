...
embedding_folder = os.path.join(root_dir, "data", "mimic", "cxr-foundation")
embedding_path = os.path.join(embedding_folder, "embedding_metadata.pkl")
...
if single:
    results_folder = "mimic/cxr-foundation-single"
else:
    results_folder = "mimic/cxr-foundation-all"
